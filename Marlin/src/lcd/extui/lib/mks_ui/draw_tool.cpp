...
//  lv_refr_now(lv_refr_get_disp_refreshing());
  ...
  #if ENABLED(BLTOUCH)
    lv_big_button_create(scr, "F:/bmp_leveling.bin", tool_menu.leveling, BTN_X_PIXEL+INTERVAL_V*2, BTN_Y_PIXEL+INTERVAL_H+titleHeight, event_handler, ID_T_MLEVELING);
  #endif
